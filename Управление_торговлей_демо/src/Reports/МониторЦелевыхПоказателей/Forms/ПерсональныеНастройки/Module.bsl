...
Процедура ЗаполнитьВариантыАнализа(ВариантыАнализаПоУмолчанию = Ложь)
	...
	Если НЕ ВариантыАнализаПользовательскиеНастройки = Неопределено
		И НЕ ВариантыАнализаПользовательскиеНастройки.Получить() = Неопределено
		И НЕ ВариантыАнализаПоУмолчанию Тогда
		Запрос.УстановитьПараметр("ВариантыАнализа", ВариантыАнализаПользовательскиеНастройки.Получить());
