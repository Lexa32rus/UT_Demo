...
Функция ДанныеКонтрагентаПоИНН(ЭтоЮридическоеЛицо, ИНН, ИдентификаторЗадания) Экспорт
	...
	Если ЭтоЮридическоеЛицо Тогда
		...
		ПартнерыИКонтрагентыЛокализация.ПреобразоватьРезультатСведенийОЮрЛице(РеквизитыЮридическогоЛица);
...
Процедура ИсторияРеквизитовВСтруктуру(Реквизиты) Экспорт
	...
	Если Реквизиты.Свойство("ДанныеРуководителей") Тогда
		
		Если Реквизиты.ДанныеРуководителей.Свойство("Руководители")
			И ТипЗнч(Реквизиты.ДанныеРуководителей.Руководители) = Тип("ТаблицаЗначений") Тогда
			
			ИменаКолонок = ИменаКолонокТаблицыБезТипа(Реквизиты.ДанныеРуководителей.Руководители);
			
			Если ИменаКолонок.Количество() > 0 Тогда
			
				Для Каждого СтрокаТаблицы Из Реквизиты.ДанныеРуководителей.Руководители Цикл
					
					Для Каждого ИмяКолонки Из ИменаКолонок Цикл
						
						Если ТипЗнч(СтрокаТаблицы[ИмяКолонки]) = Тип("ТаблицаЗначений") Тогда
							СтрокаТаблицы[ИмяКолонки] = ОбщегоНазначения.ТаблицаЗначенийВМассив(СтрокаТаблицы[ИмяКолонки]);
						КонецЕсли;
		...
		Реквизиты.ДанныеРуководителей.Руководители = ОбщегоНазначения.ТаблицаЗначенийВМассив(Реквизиты.ДанныеРуководителей.Руководители); 
...
Функция ИменаКолонокТаблицыБезТипа(Таблица)
	
	МассивИмен = Новый Массив;
	
	Для Каждого КолонкаТаблицы Из Таблица.Колонки Цикл
		
		Если КолонкаТаблицы.ТипЗначения = Новый ОписаниеТипов Тогда
			
			МассивИмен.Добавить(КолонкаТаблицы.Имя);
