...
Процедура ПолучитьДанныеБронирования() Экспорт
	...
	ТекущийИдентификаторБронирования = Неопределено;
	...
	Для каждого СтрокаБронирования Из Бронирования Цикл
		...
		Если ОтветСервиса.Свойство("result")
			И ОтветСервиса["result"].Свойство("content")
			И ТекущийИдентификаторБронирования <> ИдентификаторБронирования Тогда
			...
			КонецЕсли;
			ТекущийИдентификаторБронирования = ИдентификаторБронирования;
		КонецЕсли;
	КонецЦикла;
