...
Функция ВидОперации(Знач ЗначениеПоиска, ВидПродукции = Неопределено, ОбъемноСортовойУчет = Ложь) Экспорт
	...
	Иначе
		...
		ИначеЕсли ЗначениеПоиска = Перечисления.ВидыОперацийИСМП.ВыводИзОборотаРозничнаяПродажа
			...
			Или ЗначениеПоиска = Перечисления.ВидыОперацийИСМП.ВыводИзОборотаПродажаПоОбразцамДистанционнаяПродажа
			...
			Или ЗначениеПоиска = Перечисления.ВидыОперацийИСМП.ВыводИзОборотаИстечениеСрокаГодности Тогда
...
Функция ВидУпаковки(Знач ЗначениеПоиска, ВидПродукции, ЗначениеПоискаДополнительное = Неопределено) Экспорт
	...
	Если ИнтеграцияИСПовтИсп.ЭтоПродукцияМОТП(ВидПродукции) Тогда
		...
		ИначеЕсли ЗначениеПоиска = "SET" Или ЗначениеПоискаДополнительное = "SET" Тогда
...
Функция ПричинаВыводаИзОборота(Знач ЗначениеПоиска, ВидПродукции = Неопределено) Экспорт
	...
	ИначеЕсли ЗначениеПоиска = Перечисления.ВидыОперацийИСМП.ВыводИзОборотаБрак Тогда
		Возврат "0. Брак";
	ИначеЕсли ЭтоТабачнаяПродукция
		И ЗначениеПоиска = Перечисления.ВидыОперацийИСМП.ВыводИзОборотаИстечениеСрокаГодности Тогда
	...
	ИначеЕсли ЭтоТабачнаяПродукция
		И ЗначениеПоиска = Перечисления.ВидыОперацийИСМП.ВыводИзОборотаОтзывСРынка Тогда
	...
	ИначеЕсли ЗначениеПоиска = Перечисления.ВидыОперацийИСМП.ВыводИзОборотаДругое Тогда
		Возврат "OTHER";
	...
	ИначеЕсли ЗначениеПоиска = "BY_SAMPLES" Или ЗначениеПоиска = "REMOTE_SALE" Или ЗначениеПоиска = "DISTANCE"
