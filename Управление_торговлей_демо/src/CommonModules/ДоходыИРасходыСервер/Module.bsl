...
Функция СтатьяАналитикаРасходовПоУмолчанию(ХозяйственнаяОперация, Организация, Подразделение, Номенклатура) Экспорт
	...
	|ИЗ
	|	ОтборПрочихРасходов КАК ОтборПрочихРасходов
	|	ЛЕВОЕ СОЕДИНЕНИЕ
	|		РегистрНакопления.ПрочиеРасходы КАК ПрочиеРасходы
	|	ПО
	|		ПрочиеРасходы.АналитикаУчетаНоменклатуры = ОтборПрочихРасходов.АналитикаУчетаНоменклатуры
	|		И ПрочиеРасходы.Организация = ОтборПрочихРасходов.Организация
	|		И ПрочиеРасходы.Подразделение = ОтборПрочихРасходов.Подразделение
	|		И ПрочиеРасходы.ХозяйственнаяОперация = ОтборПрочихРасходов.ХозяйственнаяОперация 	
	|ГДЕ
	|	НЕ ПрочиеРасходы.Регистратор ЕСТЬ NULL
	|
	|УПОРЯДОЧИТЬ ПО
