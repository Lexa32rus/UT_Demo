...
Функция ПоставитьКОбработкеДокументыНачисленияИСписанияПослеВозвратаРеализации(ДатаНачалаРаботыМеханизмаБонусныхБаллов_2_5, РазмерПорции = Неопределено, ТекстОшибки = "") Экспорт
	...
	РезультатЗапросаВозвраты = РезультатЗапроса[2];
	РезультатЗапросаНачисленияИСписания = РезультатЗапроса[3];
...
Функция РаспределитьСписаниеСрочныхБонусныхБалловВСтатусеКОбработке(ДатаНачалаРаботыМеханизмаБонусныхБаллов_2_5, РазмерПорции = Неопределено, ТекстОшибки = "") Экспорт
	...
	РезультатЗапросаОстатки = РезультатЗапроса[2];
	РезультатЗапросаСписание = РезультатЗапроса[1];
...
Функция РезультатЗапросаСписаниеБонусныхБалловВСтатусеКОбработке(
	...
	|	СписаниеБонусныхБалловКОбработке.ДокументСписанияБонусныхБаллов,
	...
	|	СписаниеБонусныхБалловКОбработке.СуммаСписанияБонусныхБаллов
	|ИЗ
	|	СписаниеБонусныхБалловКОбработке КАК СписаниеБонусныхБалловКОбработке
	|
	|УПОРЯДОЧИТЬ ПО
	|	ДатаСписанияБонусныхБаллов,
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Процедура = "БонусныеБаллыСервер.Установить_ДатаНачалаРаботыМеханизмаБонусныхБаллов_2_5";
	Обработчик.Версия = "11.5.9.45";
	Обработчик.РежимВыполнения = "Монопольно";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("f6f8168d-0609-0843-8d39-28b35ceaf33f");
	ШаблонКомментария = НСтр("ru = 'Установка константы ""%1"". Влияет на движения в регистре накопления ""%2"". Для действующих срочных бонусных баллов, у которых остатки на момент выполненния обновления по ресурсу ""%3"" больше нуля реквизит ""%4"" будет заполнен значением этой константы.'");
	Обработчик.Комментарий = СтрШаблон(ШаблонКомментария, Метаданные.Константы.ДатаНачалаРаботыМеханизмаБонусныхБаллов_2_5.Имя
														, Метаданные.РегистрыНакопления.БонусныеБаллы.Синоним
														, Метаданные.РегистрыНакопления.БонусныеБаллы.Ресурсы.КСписанию.Синоним
														, Метаданные.РегистрыНакопления.БонусныеБаллы.Реквизиты.ДатаКОбработке.Синоним);
	Читаемые = Новый Массив;
	Обработчик.ЧитаемыеОбъекты = СтрСоединить(Читаемые, ",");
	
	Изменяемые = Новый Массив;
	Изменяемые.Добавить(Метаданные.Константы.ДатаНачалаРаботыМеханизмаБонусныхБаллов_2_5.ПолноеИмя());
	Обработчик.ИзменяемыеОбъекты = СтрСоединить(Изменяемые, ",");
	
	Блокируемые = Новый Массив;
	Блокируемые.Добавить(Метаданные.Константы.ДатаНачалаРаботыМеханизмаБонусныхБаллов_2_5.ПолноеИмя());
	Обработчик.БлокируемыеОбъекты = СтрСоединить(Блокируемые, ",");
	
КонецПроцедуры

Процедура Установить_ДатаНачалаРаботыМеханизмаБонусныхБаллов_2_5() Экспорт
	
	МенеджерЗначения = Константы.ДатаНачалаРаботыМеханизмаБонусныхБаллов_2_5.СоздатьМенеджерЗначения();
