...
#Область СловарьСопоставленияНоменклатурыБЭД

Процедура УстановитьИспользованиеСловаряСопоставленияНоменклатурыБЭД(Использование) Экспорт
...
Процедура ВключитьИспользованиеФОСловаряСопоставленияНоменклатурыБЭД() Экспорт
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьСловарьСопоставленияНоменклатурыБЭД") = ИспользоватьСловарь Тогда
		Возврат;
	КонецЕсли;
	УстановитьИспользованиеСловаряСопоставленияНоменклатурыБЭД(ИспользоватьСловарь);
