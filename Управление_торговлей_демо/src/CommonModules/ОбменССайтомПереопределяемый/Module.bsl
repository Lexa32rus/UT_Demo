...
Процедура ПолучитьТекстыЗапросовПакетаПредложений2_5(ТекстыЗапросов) Экспорт
	...
	|
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	ДоступныеСоглашенияСоглашения.ИндивидуальныйВидЦен КАК Поле1
	|ИЗ
	|	ДоступныеСоглашенияСоглашения КАК ДоступныеСоглашенияСоглашения
	|;
	|
	...
	|		ИЗ
	|			ДоступныеСоглашенияСоглашенияВидыЦен) {(Номенклатура).* КАК Номенклатура}) КАК ЦеныНоменклатурыСрезПоследних
	|ГДЕ
