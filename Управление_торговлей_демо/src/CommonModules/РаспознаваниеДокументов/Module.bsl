...
Процедура ЗагрузитьРаспознанныеДокументы(АдресРезультата = Неопределено, СостоянияПоБалансу = Неопределено) Экспорт
	...
	Если ЭтоАдресВременногоХранилища(АдресРезультата) Тогда
		...
		РезультатРаспознавания.Вставить("СостоянияПоСтатусам", СостоянияПоСтатусам());
		РезультатРаспознавания.Вставить("СостоянияПоБалансу", СостоянияПоБалансу);
		ПоместитьВоВременноеХранилище(РезультатРаспознавания, АдресРезультата);
	КонецЕсли;
	
	Если Не СостоянияПоБалансу.ВыполнятьЗагрузкуРезультатов Тогда
		Возврат;
	КонецЕсли;
...
Процедура ОбменССервисомРаспознаванияДокументов() Экспорт
	...
	РаспознаваниеДокументовОбменССервисом.ВыполнитьОбменССервисомРаспознаванияДокументов();
...
Функция СостоянияПоСтатусам()
	...
	Если ФайловКОбработке = Null Тогда
		ФайловКОбработке = 0;
	КонецЕсли;
