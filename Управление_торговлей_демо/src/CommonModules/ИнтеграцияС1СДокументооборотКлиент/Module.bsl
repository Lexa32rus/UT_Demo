...
Процедура ВыполнитьПодключаемуюКомандуИнтеграции(Команда, Форма, Источник) Экспорт
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("ВыполнитьПодключаемуюКомандуИнтеграцииПроверитьПодключение",
...
//
Процедура ВыполнитьПодключаемуюКомандуИнтеграцииПроверитьПодключение(Результат, Параметры) Экспорт
...
Процедура ПрерватьСогласование(Параметры) Экспорт
	...
	Результат = ИнтеграцияС1СДокументооборотБазоваяФункциональностьВызовСервера.
