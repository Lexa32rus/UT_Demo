...
Функция ОперацииВыводаИзОборотаПоВидуПродукции(ВидПродукции, ОбъемноСортовойУчет = Неопределено) Экспорт
	...
	Иначе
		...
		Если ВидПродукции <> ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.УпакованнаяВода")
			И Не ОбъемноСортовойУчет Тогда
			ВозвращаемоеЗначение.Добавить(
...
Функция ИспользованиеКонтрагентаПриВыводеИзОборота(Операция, ТолькоОбязательное = Ложь) Экспорт
...
Функция ИспользованиеПервичногоДокументаПриВыводеИзОборота(Операция, ТолькоОбязательное = Ложь) Экспорт
	...
	ИначеЕсли ТолькоОбязательное Тогда
		...
		Использование = Не (
			    Операция = ПредопределенноеЗначение("Перечисление.ВидыОперацийИСМП.ВыводИзОборотаПродажаПоОбразцамДистанционнаяПродажа")
...
Функция ОперацииОбязательногоИспользованиеЦеныПриВыводеИзОборота() Экспорт
	...
	ВозвращаемоеЗначение.Добавить(ПредопределенноеЗначение("Перечисление.ВидыОперацийИСМП.ВыводИзОборотаПродажаПоОбразцамДистанционнаяПродажа"));
...
Функция ИспользованиеGLNКонтрагентаПриОтгрузкеТоваров(Операция, ТолькоОбязательное = Ложь) Экспорт
	...
	ЭтоОбязательноеИспользование = (ОбязательныеОперации.НайтиПоЗначению(Операция) <> Неопределено);
	Использование = ЭтоОбязательноеИспользование;
...
Функция ОперацииОбязательногоИспользованияGLNПриОтгрузкеТоваров() Экспорт
	...
	ВозвращаемоеЗначение = Новый СписокЗначений();
	ВозвращаемоеЗначение.Добавить(ПредопределенноеЗначение("Перечисление.ВидыОперацийИСМП.ОтгрузкаЕАЭССПризнаниемКИ"));
