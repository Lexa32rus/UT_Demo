...
Процедура ОбработкаПроверкиЗаполнения(Объект, Отказ, ПроверяемыеРеквизиты) Экспорт
	...
	ДенежныеСредстваСерверЛокализация.ПроверитьЗаполнениеКодаВидаДохода(Объект,
																		...
																		Отказ);
	ДенежныеСредстваСерверЛокализация.ПроверитьВыгрузкуРеестраНаЗачислениеДенежныхСредств(Объект, Отказ, ПроверяемыеРеквизиты, ФлагОбменСБанками);
...
//    * МассивДокументов - Массив - список документов, для которых выполняется выгрузка файла
//    * УникальныйИдентификаторФормы - Строка - идентификатор формы документа, из которого выполняется формирование файла
//    * МассивОписанийФайлов - Массив - пустой массив для заполнения структурой будущего файла
//
...
//
// Параметры:
//  КоллекцияДокументов - Массив - документы, по которым необходимо получить данные для выгрузки.
//
// Возвращаемое значение:
//   Соответствие - содержит структуру данных отдельно по документам.
//
