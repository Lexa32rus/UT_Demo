...
Процедура ПриПолученииПредопределенныхНаборовСвойств(Наборы) Экспорт
	...
	Если Наборы.Строки.Найти("Документ_ПодтверждениеЗачисленияЗарплаты", "Имя") = Неопределено Тогда
	
		Набор = Наборы.Строки.Добавить();
		Набор.Имя = "Документ_ПодтверждениеЗачисленияЗарплаты";
		Набор.Идентификатор = Новый УникальныйИдентификатор("4173f13b-20dc-441a-bff2-b7d1e9688667");
