...
Процедура ВыполнитьОбменССервисомРаспознаванияДокументов() Экспорт
	...
	ВыполитьОтправкуОбратнойСвязиRecognitionResult(Узел, НомерТекущегоПакета, ОтправкаУдалась);
...
Процедура ВыполитьОтправкуОбратнойСвязиRecognitionResult(Узел, НомерТекущегоПакета, ОтправкаУдалась)
