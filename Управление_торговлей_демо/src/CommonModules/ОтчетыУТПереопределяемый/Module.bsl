...
Процедура НастроитьПараметрыОтборыПоФункциональнымОпциям(Форма, НовыеНастройкиКД)
	...
	Если ИмяОтчета = "СправкаРасчетПереоценкиВалютныхСредств"
		...
		Если НовыеНастройкиКД.Структура[0].Структура.Количество() > 0 Тогда
			...
			КомпоновкаДанныхСервер.УдалитьГруппуВыбранногоПоляИзВсехНастроекОтчета(КолонкиТаблицы, "ТребуетсяНУ");
			КомпоновкаДанныхСервер.УдалитьГруппировкуИзВсехНастроекОтчета(НовыеНастройкиКД, "СчетУчета");
			...
			КомпоновкаДанныхСервер.УдалитьЭлементОтбораИзВсехНастроекОтчета(ГруппировкаРаздел, "ТребуетсяНУ");
			...
			КомпоновкаДанныхСервер.УдалитьЭлементОтбораИзВсехНастроекОтчета(ГруппировкаАналитика, "ТребуетсяНУ");
