...
Процедура ОбработатьПереходСправочникаПодключаемоеОборудованиеНаОфлайнОборудование(СсылкаНаПодключаемоеОборудование, СсылкаНаОфлайнОборудование) Экспорт
	...
	ОфлайнОборудованиеОбъект.УзелИнформационнойБазы = СсылкаНаПодключаемоеОборудование.УзелИнформационнойБазы;
	ОфлайнОборудованиеОбъект.ПравилоОбмена = СсылкаНаПодключаемоеОборудование.ПравилоОбмена;
