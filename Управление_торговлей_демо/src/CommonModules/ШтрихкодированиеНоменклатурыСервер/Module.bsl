...
//	* СчитывательRFID - Структура - элемент массива см. Справочники.ПодключаемоеОборудование.ОборудованиеПоПараметрам.
...
//	* ЗначенияПолейСвязи - Структура, ФиксированнаяСтруктура - коллекция связи полей.
//
