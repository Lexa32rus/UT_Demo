...
//         Результат - Структура
//           * РезультатОперации - Структура - результат выполнения пакета операций
//                            См. ОборудованиеЧекопечатающиеУстройстваКлиент.РезультатФискализацииЧекаСОплатойКартой()
...
//     * Результат - Структура - См. ОборудованиеЧекопечатающиеУстройстваКлиент.РезультатФискализацииЧекаСОплатойКартой();
//   ИдентификаторКлиента - ФормаКлиентскогоПриложения - идентификатор формы.
...
//   ПараметрыОперации - Структура - См. ПараметрыФискализацияЧекаСОплатойКартой().
...
//               см. ОборудованиеЧекопечатающиеУстройстваКлиент.КонтекстФискализацииЧекаСОплатойКартой()
...
//     * ПараметрыФискализацииЧека - Структура - 
//                            См. ОборудованиеЧекопечатающиеУстройстваКлиентСервер.ПараметрыОперацииФискализацииЧека()
//     * ПараметрыФискализацииЧекаВыдачи - Структура - если Неопределено, тогда чек будет сформирован автоматически
//                            на основании параметров чека продажи и параметров эквайринговой операции.
//                            См. ОборудованиеЧекопечатающиеУстройстваКлиентСервер.ПараметрыОперацииФискализацииЧека()
//     * ПараметрыФискализацииЧекаВозврата - Структура - чек возврата для формирования если фискализация продажи 
//                            не была выполнена успешно, если Неопределено, тогда чек будет сформирован автоматически 
//                            на основании параметров чека продажи.
//                            См. ОборудованиеЧекопечатающиеУстройстваКлиентСервер.ПараметрыОперацииФискализацииЧека()
//     * ПараметрыВыполненияЭквайринговойОперации - Структура - 
//                            См. ОборудованиеПлатежныеСистемыКлиент.ПараметрыВыполненияЭквайринговойОперации()
...
//     * ДанныеАгента - Структура - данные банковского платежного агента, для автоматического формирования чека выдачи
//                            См. ОборудованиеЧекопечатающиеУстройстваКлиентСервер.ПараметрыДанныеАгента()
//     * ДанныеПоставщика - Структура - данные поставщика, для автоматического формирования чека выдачи,
//                            в соответствии с ФФД.
//                            если пользователь является банковским платежным агентом (субагентом), то в реквизите 
//                            "данные поставщика" (тег 1224) должны быть указаны данные лица, являющегося получателем 
//                            средств банковского платежного агента (субагента) в соответствии с Федеральным законом 
//                            от 27 июня 2011 года N 161-ФЗ "О национальной платежной системе".
//                            См. ОборудованиеЧекопечатающиеУстройстваКлиентСервер.ПараметрыДанныеПоставщика()
//     * СлипЧекВТелеФискального - Булево, Неопределено - Выводить слип-чек в теле фискального, Истина - слип-чек будет выведен
//                            в теле фискального, Ложь - короткий слип-чек не будет выводиться, Неопределено - короткий слип-чек 
//                            будет выводиться если поддерживает драйвер оборудования.
...
//
// Параметры:
//   ПараметрыОперации - Структура - см. ПараметрыПродажаСВыдачейНаличных()
//
...
//   ОповещениеПриЗавершении - ОписаниеОповещения - Описание процедуры которая будет вызвана при завершении операции
//                             со следующими параметрами:
//     * Результат - Структура - См. ОборудованиеЧекопечатающиеУстройстваКлиент.РезультатПродажаСВыдачейНаличных();
//   ИдентификаторКлиента - ФормаКлиентскогоПриложения - идентификатор формы.
//   ИдентификаторККТ - СправочникСсылка.ПодключаемоеОборудование - ККТ на котором будет печататься фискальный чек
//                      содержащий в себе слип-чек.
//   ИдентификаторЭТ - СправочникСсылка.ПодключаемоеОборудование - Эквайринговый терминал для обработки операции.
...
//   КонтекстОперации - Структура - См. ОборудованиеЧекопечатающиеУстройстваКлиент.КонтекстФискализацииЧекаСОплатойКартой()
...
// Параметры:
//   РезультатВыполнения - Структура - См. МенеджерОборудованияКлиентСервер.ПараметрыВыполненияОперацииНаОборудовании()
//   КонтекстОперации - Структура - См. ОборудованиеЧекопечатающиеУстройстваКлиент.КонтекстПродажаСВыдачейНаличных()
...
Функция РезультатФискализацииЧекаСОплатойКартой(РезультатОперации, ОписаниеОшибки, КонтекстОперации)
...
//   * ДополнительныеПараметры - Структура - Дополнительные параметры которые можно передать в операции 
//                               оплаты и фискализации
Функция КонтекстФискализацииЧекаСОплатойКартой()
...
//   РезультатОперации - Булево - Результат выполнения пакета операций
//   ОписаниеОшибки - Строка - Описание ошибки выполнения пакета операции
//   КонтекстОперации - Структура - см. ПакетнаяОбработкаКлиент.КонтекстФискализацииЧекаСОплатойКартой()
//
// Возвращаемое значение:
//  Структура:
//    * Результат - Булево - Результат выполнения пакета операций.
...
//                                   См. МенеджерОборудованияКлиентСервер.ПараметрыВыполненияОперацииНаОборудовании()
//    * РезультатФискализацииЧекаВозврата - Структура - 
//                                   См. МенеджерОборудованияКлиентСервер.ПараметрыВыполненияОперацииНаОборудовании()
//    * РезультатАварийнойОтменыОперации - Структура - 
//                                   См. МенеджерОборудованияКлиентСервер.ПараметрыВыполненияОперацииНаОборудовании()
...
//                                   См. ОборудованиеЧекопечатающиеУстройстваКлиентСервер.ПараметрыПакетнойОперацииВОчередиЧеков()
Функция РезультатПродажаСВыдачейНаличных(РезультатОперации, ОписаниеОшибки, КонтекстОперации)
...
//   * ПараметрыФискализацииЧека - Структура - 
//                              См. ОборудованиеЧекопечатающиеУстройстваКлиентСервер.ПараметрыОперацииФискализацииЧека()
//   * ПараметрыФискализацииЧекаВыдачи - Структура - 
//                              См. ОборудованиеЧекопечатающиеУстройстваКлиентСервер.ПараметрыОперацииФискализацииЧека()
//   * ПараметрыФискализацииЧекаВозврата - Структура - 
//                              См. ОборудованиеЧекопечатающиеУстройстваКлиентСервер.ПараметрыОперацииФискализацииЧека()
//   * ПараметрыВыполненияЭквайринговойОперации - Структура - 
//                              См. ОборудованиеПлатежныеСистемыКлиентСервер.ПараметрыВыполненияЭквайринговойОперации()
//   * РезультатВыполненияЭквайринговойОперации - Структура - 
...
//                               оплаты и фискализации
//
Функция КонтекстПродажаСВыдачейНаличных()
...
Процедура ПроверитьКорректностьБанковскогоАгента(КонтекстОперации, ОписаниеОшибки)
	...
	Если ПараметрыЧекаВыдачи.ПозицииЧека.Количество()=0 Тогда
		...
		ОписаниеОшибки = ОписаниеОшибки + ТекстОшибки + Символы.ПС;
	Иначе
		ДанныеАгентаПозиция = ПараметрыЧекаВыдачи.ПозицииЧека[0].ДанныеАгента;
		ДанныеАгентаШапка   = ПараметрыЧекаВыдачи.ДанныеАгента;
		
		Если ДанныеАгентаПозиция.ОператорПеревода.Телефон = Неопределено 
			И ДанныеАгентаШапка.ОператорПеревода.Телефон = Неопределено Тогда
			ТекстОшибки    = НСтр("ru = 'Не установлен телефон оператора перевода банковского платежного агента.'") ;
			ОписаниеОшибки = ОписаниеОшибки + ТекстОшибки + Символы.ПС;
		КонецЕсли;
		
		Если ДанныеАгентаПозиция.ОператорПеревода.Наименование = Неопределено 
			И ДанныеАгентаШапка.ОператорПеревода.Наименование = Неопределено Тогда
			ТекстОшибки    = НСтр("ru = 'Не установлено наименование оператора перевода банковского платежного агента.'") ;
			ОписаниеОшибки = ОписаниеОшибки + ТекстОшибки + Символы.ПС;
		КонецЕсли;
		
		Если ДанныеАгентаПозиция.ОператорПеревода.Адрес = Неопределено 
			И ДанныеАгентаШапка.ОператорПеревода.Адрес = Неопределено Тогда
			ТекстОшибки    = НСтр("ru = 'Не установлен адрес оператора перевода банковского платежного агента.'") ;
			ОписаниеОшибки = ОписаниеОшибки + ТекстОшибки + Символы.ПС;
		КонецЕсли;
		
		Если ДанныеАгентаПозиция.ОператорПеревода.ИНН = Неопределено 
			И ДанныеАгентаШапка.ОператорПеревода.ИНН = Неопределено Тогда
			ТекстОшибки    = НСтр("ru = 'Не установлен ИНН оператора перевода банковского платежного агента.'") ;
			ОписаниеОшибки = ОписаниеОшибки + ТекстОшибки + Символы.ПС;
		КонецЕсли;
		
		Если ДанныеАгентаПозиция.ПлатежныйАгент.Телефон = Неопределено 
			И ДанныеАгентаШапка.ПлатежныйАгент.Телефон = Неопределено Тогда
			ТекстОшибки    = НСтр("ru = 'Не установлен телефон банковского платежного агента.'") ;
			ОписаниеОшибки = ОписаниеОшибки + ТекстОшибки + Символы.ПС;
		КонецЕсли;
...
Процедура ПодготовитьПараметрыЭквайринговойОперации(КонтекстОперации)
	...
	Если ПараметрыВыполненияЭквайринговойОперации = Неопределено Тогда
		...
		ПараметрыВыполненияЭквайринговойОперации = ОборудованиеПлатежныеСистемыКлиентСервер.ПараметрыВыполненияЭквайринговойОперации();
...
Процедура ВывестиСлипЧекКакТекстовыйДокумент(Тип, КонтекстОперации)
	...
	Если Не ПустаяСтрока(Текст) Тогда
		глПодключаемоеОборудование.Вставить("ПоследнийСлипЧек", Текст);
	КонецЕсли;
