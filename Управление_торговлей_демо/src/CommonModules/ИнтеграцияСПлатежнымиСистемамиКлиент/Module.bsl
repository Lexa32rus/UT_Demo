...
Процедура ОткрытьФормуПлатежнойСсылкиСБППослеОтветаЗавершение(ПараметрыНастройки, Параметры)
	...
	ИначеЕсли ИнтеграцияСПлатежнымиСистемамиВызовСервера.НастройкаИнтеграцияДоступна() Тогда
		...
		ПараметрыЗавешения = Новый Структура;
		ПараметрыЗавешения.Вставить("ОснованиеПлатежа", Параметры.ОснованиеПлатежа);
		ПараметрыЗавешения.Вставить("НоваяТорговаяТочка", Неопределено);
		
		ПараметрыОповещения = Новый Структура;
		ПараметрыОповещения.Вставить("ПараметрыЗавешения", ПараметрыЗавешения);
