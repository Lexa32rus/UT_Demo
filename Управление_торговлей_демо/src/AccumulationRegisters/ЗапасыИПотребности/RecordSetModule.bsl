...
Процедура ОтключитьЗаписьГрафика() Экспорт
	
	ДополнительныеСвойства.Вставить("ОтключитьЗаписьГрафика");
...
Процедура ПередЗаписью(Отказ, Замещение)
	...
	Заказы = РегистрыНакопления.ЗапасыИПотребности.УстановитьБлокировкиЗаказовИТоваров(ЭтотОбъект, ЭтотОбъект.Отбор.Регистратор.Значение, Ложь);
	...
	Если ДополнительныеСвойства.Свойство("ОтключитьЗаписьГрафика") Тогда
		Возврат;
	КонецЕсли;
...
#Область ЗаписьРасчетныхДанных

Процедура ЗакрытьГрафикПоЗаказам()
