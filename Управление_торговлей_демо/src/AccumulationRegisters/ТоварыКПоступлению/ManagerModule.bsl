...
// 
// Параметры:
//  Распоряжения - Массив - Документы распоряжения
// 
// Возвращаемое значение:
...
Функция ПолучитьОрдераПоРаспоряжению(Распоряжения) Экспорт
	...
	|	Таблица.ДокументПоступления.Склад КАК Склад
	|ИЗ
	...
	|	Таблица.Регистратор,
	|	Таблица.ДокументПоступления,
	|	Таблица.ДокументПоступления.Склад";
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Версия = "11.5.9.88";
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("2703a727-046d-4903-8fd0-6bc799adab1e");
