...
Процедура ДатаОкончанияПриИзменении(Элемент)
	...
	ПредставлениеПериодаРегистрации = СформироватьПредставлениеПериодаРегистрации();
	УстановитьДоступностьРежимаЗакрытияМесяца();
...
&НаСервере
Функция СформироватьПредставлениеПериодаРегистрации()
	Возврат РасчетСебестоимостиУниверсальныеАлгоритмы.ПредставлениеПериодаМесяцГод(Объект.ПериодРегистрации);
КонецФункции
