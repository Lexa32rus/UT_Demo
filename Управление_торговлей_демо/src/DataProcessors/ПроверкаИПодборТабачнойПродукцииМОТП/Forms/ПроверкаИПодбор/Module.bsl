...
Процедура ОбработкаВыбора(ВыбранноеЗначение, ИсточникВыбора)
	...
	Если ИнтеграцияИСКлиент.ЭтоЗагрузкаКодовМаркировки(ИсточникВыбора, ЭтотОбъект) Тогда
		...
		Подключаемый_ПолученыДанныеИзТСД(ВыбранноеЗначение);
	КонецЕсли;
...
&НаКлиенте
Процедура Подключаемый_ПолученыДанныеИзТСД(Штрихкоды, ПараметрыОбработкиТСД = Неопределено) Экспорт
	
	Если ПараметрыОбработкиТСД = Неопределено Тогда
		ПараметрыОбработкиТСД = НовыеПараметрыОбработкиТСД();
	КонецЕсли;
