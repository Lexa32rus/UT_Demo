...
Процедура ДобавитьСсылкуНаСуществующийФайл(ИдентификаторФайла)
	...
	Запрос.linkedObject = ИнтеграцияС1СДокументооборотБазоваяФункциональность.СоздатьObjectID(Прокси,
...
Процедура СкопироватьСуществующийФайл(ИдентификаторФайла)
	...
	ОбъектID = ИнтеграцияС1СДокументооборотБазоваяФункциональность.СоздатьObjectID(Прокси, ИдентификаторФайла, "DMFile");
