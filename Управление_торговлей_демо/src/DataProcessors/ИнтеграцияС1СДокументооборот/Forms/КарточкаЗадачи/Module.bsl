...
Функция ПолучитьHTMLПредставлениеФормыЗадачи(Тип, Ид)
	...
	Ответ = ИнтеграцияС1СДокументооборотБазоваяФункциональность.ПолучитьОбъект(Прокси, Тип, Ид, Колонки);
...
Функция ПолучитьПараметрыБизнесПроцесса()
	...
	ДанныеЗадачи = ИнтеграцияС1СДокументооборотБазоваяФункциональность.ПолучитьОбъект(Прокси, "DMBusinessProcessTask", ID);
