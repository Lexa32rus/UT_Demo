...
Процедура НастроитьЭлементыФормы()
	...
	Если НомерСтраницы = 6 Тогда
		...
		Элементы.РаспоряженияНаОформлениеОприходованийОформитьПроизводствоБезЗаказа.Видимость = ПроизводствоБезЗаказов;
		Элементы.ДекорацияШаг6СмТакже.Видимость = ПроизводствоБезЗаказов;
