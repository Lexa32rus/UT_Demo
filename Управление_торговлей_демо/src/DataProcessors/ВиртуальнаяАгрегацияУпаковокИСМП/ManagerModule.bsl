...
Процедура ЗаполнитьНаборы(Параметры, ОстаткиПродукции)
	...
	ШаблонНабора = ИнтеграцияИСМПКлиентСервер.ШаблонКодаМаркировкиПоВидуПродукции(Параметры.ВидПродукции, 5);
	...
	ОтборСтрок.Вставить("Шаблон", ШаблонНабора);
	
	ТаблицаДанных = ОстаткиПродукции.Скопировать(ОтборСтрок, "НомерСтроки,Номенклатура,Характеристика,GTIN,Количество");
...
Процедура ЗаполнитьГрупповыеУпаковки(Параметры, ОстаткиПродукции)
	...
	ШаблонГрупповойУпаковки = ИнтеграцияИСМПКлиентСервер.ШаблонКодаМаркировкиПоВидуПродукции(Параметры.ВидПродукции, 4);
	...
	Для Каждого Строка Из ОстаткиПродукции Цикл
		...
		Если Строка.Шаблон <> ШаблонГрупповойУпаковки Тогда
			Продолжить;
		КонецЕсли;
	...
	Для Каждого Строка Из СтрокиДляОбработки Цикл
		...
		Для Каждого НайденнаяСтрока Из НайденныеСтроки Цикл
			Если НайденнаяСтрока.Шаблон <> ШаблонГрупповойУпаковки Тогда
