...
Процедура ОбновитьТаблицуЦенНаСервере() 
	...
	|		ВЫБОР КОГДА ЦеныНоменклатуры25СрезПоследних.ВидЦены = ЦенаПродажиЯндексМаркет.Значение ТОГДА ЦеныНоменклатуры25СрезПоследних.Цена ИНАЧЕ 0 КОНЕЦ КАК ЦенаПродажи,
	...
	|				Константа.ЦенаПродажиЯндексМаркет КАК ЦенаПродажиЯндексМаркет
	|	ГДЕ
	...
	|		ИЛИ ЦеныНоменклатуры25СрезПоследних.ВидЦены = ЦенаПродажиЯндексМаркет.Значение 
	|		)) КАК АктуальныеЦены
	|	СГРУППИРОВАТЬ ПО 
