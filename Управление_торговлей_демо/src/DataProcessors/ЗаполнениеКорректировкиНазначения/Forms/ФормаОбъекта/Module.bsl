...
Процедура ЗаполнитьТаблицу()
	...
	Если НесколькоНазначений И ВидОперации = Перечисления.ВидыОперацийКорректировкиНазначения.Резервировать Тогда
		...
		ОтобразитьДекорациюЕслиТаблицаРезервированияПустая(Таблица);
...
&НаСервере
Процедура ОтобразитьДекорациюЕслиТаблицаРезервированияПустая(Таблица)
	
	Элементы.ДекорацияНетОстатков.Видимость = Таблица.Количество() = 0
		И (Параметры.ВидОперации = Перечисления.ВидыОперацийКорректировкиНазначения.Резервировать
			Или Параметры.ВидОперации = Перечисления.ВидыОперацийКорректировкиНазначения.РезервироватьИКорректировать);
