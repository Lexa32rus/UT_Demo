...
Процедура УстановитьДоступностьКомандСозданияДокументовНаВозврат()
	...
	Если ТекущиеДанные <> Неопределено
		...
		Если ТекущиеДанные.Тип = Тип("ДокументСсылка.ЧекККМ") Тогда
			...
			ОбщегоНазначенияУТКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ЧекиККМДокументЧекККМКоррекцииСоздатьНаОсновании",				 "Доступность", ЧекПробит И ПоТекущейКассеСменаОткрыта);
			...
			ОбщегоНазначенияУТКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "КонтекстноеМенюЧекиККМДокументЧекККМКоррекцииСоздатьНаОсновании",					"Доступность", ЧекПробит И ПоТекущейКассеСменаОткрыта);
