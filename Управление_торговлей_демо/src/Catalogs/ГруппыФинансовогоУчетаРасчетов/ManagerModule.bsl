...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполняет признак Расчеты в иностранной валюте. Создает ГФУ электронных билетов.'");
	...
	НоваяСтрока.Процедура = "Документы.Бронирование.ОбработатьДанныеДляПереходаНаНовуюВерсию";
	НоваяСтрока.Порядок = "До";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Процедура = "Справочники.ГруппыФинансовогоУчетаРасчетов.СоздатьГФУРасчетовПоБронированию";
	Обработчик.Версия = "11.5.9.27";
	Обработчик.РежимВыполнения = "Оперативно";
	Обработчик.Комментарий = НСтр("ru = 'Создает ГФУ расчетов по бронированию.'");
