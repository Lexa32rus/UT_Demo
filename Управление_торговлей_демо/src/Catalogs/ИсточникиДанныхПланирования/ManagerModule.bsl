...
Функция ВыбратьДанные(ПараметрыИсточникаДанных, ПользовательскиеНастройки, ДополнительныеПараметры, КомпоновщикНастроекКомпоновкиДанных = Неопределено) Экспорт
	...
	Если Реквизиты.ИмяШаблонаСКД = "СвободныеОстаткиПредопределенный" Тогда
		ЭтоПроизводительныйРежим = ОбеспечениеВДокументахСервер.ЭтоПроизводительныйРежим();
		КомпоновкаДанныхКлиентСервер.УстановитьПараметр(
			КомпоновщикНастроекКомпоновкиДанных,
			"ЭтоПроизводительныйРежимХраненияИнформацииОДоступности",
