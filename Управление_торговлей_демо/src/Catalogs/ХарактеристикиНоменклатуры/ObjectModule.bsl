...
Процедура ПередЗаписью(Отказ)
	...
	Если ФормироватьРабочееНаименование 
		...
		Если УстановитьРеквизитыЦенообразования
			...
			ПроизвестиПоискХЦО = ОбновлениеНастроекЦенообразованияВидыНоменклатуры;
			Если Не ОбновлениеНастроекЦенообразованияВидыНоменклатуры Тогда
				Если РеквизитыОбъекта.НастройкиКлючаЦенПоХарактеристике = Перечисления.ВариантОтбораДляКлючаЦен.ИспользоватьПоРеквизитам Тогда
					ПроизвестиПоискХЦО = Истина;
				ИначеЕсли РеквизитыОбъекта.НастройкиКлючаЦенПоХарактеристике = Перечисления.ВариантОтбораДляКлючаЦен.Использовать Тогда
					ПроизвестиПоискХЦО = Ложь;
				КонецЕсли;
			КонецЕсли;

			РеквизитыДляПоиска = ПолучитьРеквизитыДляПоиска(ВидНоменклатуры, РеквизитыОбъекта, ПроизвестиПоискХЦО);
...
Функция ПолучитьРеквизитыДляПоиска(Знач ВидНоменклатуры, Знач РеквизитыОбъекта, Знач ПроизвестиПоискХЦО)
