...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ХранилищеНастроек = ХранилищеНастроекКомпоновкиДанных;
	ХранилищеНастроекПеременная = ХранилищеНастроек;// ХранилищеЗначения
...
// заполняем отбор по номенктлатуре, если есть
	...
	ХранилищеНастроек = ХранилищеНастроекКомпоновкиДанныхОтбораПоНоменклатуре;
	ХранилищеНастроекПеременная = ХранилищеНастроек;// ХранилищеЗначения	
	НастройкиКомпоновщика = ХранилищеНастроекПеременная.Получить();
...
&НаСервере
Процедура ИнициализироватьНастройкиПоСпособуЗаданияЦены()
	
	ХранилищеНастроекПеременная = Объект.Ссылка.ХранилищеНастроек;//ХранилищеЗначения
	ХранилищеНастроек = ХранилищеНастроекПеременная;
	...
	Если Объект.СпособЗаданияЦены = Перечисления.СпособыЗаданияЦен.ЗагружаетсяИзЯндексМаркет Тогда
		...
		Если НастройкиПоСпособуЗаданияЦены = Неопределено Тогда
			НастройкиПоСпособуЗаданияЦены = ИнтеграцияСМаркетплейсамиСерверЛокализация.НастройкиПоСпособуЗаданияЦены();
		КонецЕсли;
		...
		Если НастройкиПоСпособуЗаданияЦены<>Неопределено Тогда	
			...
			ХранилищеНастроек = Новый ХранилищеЗначения(НастройкиПоСпособуЗаданияЦены, Новый СжатиеДанных(9));
		КонецЕсли;
	КонецЕсли;
...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	ИначеЕсли ТекущийОбъект.СпособЗаданияЦены = Перечисления.СпособыЗаданияЦен.ЗагружаетсяИзЯндексМаркет Тогда
		...
		ТекущийОбъект.ХранилищеНастроек = Новый ХранилищеЗначения(НастройкиПоСпособуЗаданияЦены, Новый СжатиеДанных(9));
