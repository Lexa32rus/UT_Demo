...
Процедура ОбъектРасчетовПриИзменении(ТекущаяСтрока) 
	...
	ЗаполнитьВалютуВзаиморасчетовДоговорИПорядокРасчетовПоОбъектуРасчетов(ТекущиеДанные.ВалютаВзаиморасчетов,
...
&НаСервереБезКонтекста
Процедура ЗаполнитьВалютуВзаиморасчетовДоговорИПорядокРасчетовПоОбъектуРасчетов(ВалютаВзаиморасчетов, Договор, ПорядокРасчетов, ОбъектРасчетов) 
...
Процедура УстановитьПараметрыВыбораРасчетногоДокумента(ИмяЭлементаРасчетныйДокумент, СтрокаТаблицы)
	...
	МассивПараметровРасчетногоДокумента.Добавить(Новый ПараметрВыбора("Отбор.Валюта",      СтрокаТаблицы.ВалютаВзаиморасчетов));
