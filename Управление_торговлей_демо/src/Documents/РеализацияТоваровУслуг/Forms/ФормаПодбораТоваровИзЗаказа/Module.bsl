...
Процедура ЗаполнитьТаблицуТоваров(Документ, ВалютаДокумента)
	...
	Для каждого СтрокаТоваров Из ТаблицаТоваров Цикл
		...
		СтрокаТоваров.СуммаБонусныхБалловКСписанию = СтрокаТоваров.СуммаБонусныхБалловКСписаниюПоЗаказу;
		СтрокаТоваров.СуммаБонусныхБалловКСписаниюВВалюте = СтрокаТоваров.СуммаБонусныхБалловКСписаниюВВалютеПоЗаказу;
		СтрокаТоваров.СуммаНачисленныхБонусныхБалловВВалюте = СтрокаТоваров.СуммаНачисленныхБонусныхБалловВВалютеПоЗаказу;
	КонецЦикла; 
