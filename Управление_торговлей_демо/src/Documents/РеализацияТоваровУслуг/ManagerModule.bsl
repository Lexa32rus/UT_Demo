...
Процедура РассчитатьСостояние(Знач РеализацияТоваровУслуг, Знач ЕстьКорректировки, СостояниеРасчетов) Экспорт
	...
	Если ЗначениеЗаполнено(РеализацияТоваровУслуг) И ПравоДоступа("Чтение", Метаданные.РегистрыНакопления.РасчетыСКлиентами) Тогда
		...
		ПараметрыВзаиморасчетов = СостояниеРасчетов.КэшДанныхМеханизмов.Взаиморасчеты.МассивПараметров;
		ДанныеПоСостоянию = ВзаиморасчетыСервер.СостояниеВзаиморасчетов(РеализацияТоваровУслуг, ПараметрыВзаиморасчетов[0]);
...
Функция ТекстЗапросаТаблицаТоварыКОформлениюОтчетовКомитенту(Запрос, ТекстыЗапроса, Регистры)
	...
	|		ПО ТаблицаВидыЗапасов.ВидЗапасов.Соглашение = СоглашенияСПоставщиками.Ссылка
...
Функция ТекстЗапросаВтБонусныеБаллы(Запрос, ТекстыЗапроса)
	...
	|ИЗ
	|	Документ.РеализацияТоваровУслуг.НачислениеБонусныхБаллов КАК ТабличнаяЧасть
	|ГДЕ
	|	ТабличнаяЧасть.Ссылка = &Ссылка
	|	И ТабличнаяЧасть.Ссылка.Статус <> ЗНАЧЕНИЕ(Перечисление.СтатусыРеализацийТоваровУслуг.КПредоплате)
	...
	|	И (ТабличнаяЧасть.КодСтроки = 0 ИЛИ НЕ &ИспользоватьРасширенныеВозможностиЗаказаКлиента)";
