...
Процедура УстановитьУсловноеОформление()
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Платежная карта'"));
	...
	ОтборЭлемента.ПравоеЗначение = Перечисления.ТипыПлатежнойСистемыККТ.СертификатНСПК;
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Оплата ЭС ФСС'"));
...
Процедура УстановитьДоступностьКомандСозданияДокументовНаВозврат()
	...
	ОбщегоНазначенияУТКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ФормаДокументЧекККМКоррекцииСоздатьНаОсновании",                 "Доступность", ЧекПробит И КассоваяСменаОткрыта);
...
Процедура ОтправитьПодтверждениеНСПКНаКлиентеЛокализация()
	...
	Иначе
		...
		ОтправитьПодтверждениеНСПКНаСервере(Объект.Ссылка, ДополнительныеПараметры.СуммаСертификатамиЭСФСС);
...
Процедура ОтправитьПодтверждениеНСПКНаСервере(ЧекККМ, СуммаСертификатамиЭСФСС)
	
	Результат = ЭлектронныеСертификатыНСПКУТ.ПередачаДанныхФискальногоЧека(ЧекККМ, СуммаСертификатамиЭСФСС);
