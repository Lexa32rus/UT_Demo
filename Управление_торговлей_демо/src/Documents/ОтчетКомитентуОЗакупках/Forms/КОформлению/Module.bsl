...
Функция РазделитьСписокНазначенийПоОтчетам()
	...
	ПараметрыУникальныхДокументов = СписокНазначений.Выгрузить(,"Организация, Комитент, ДоговорСКомитентом, КонтрагентКомитент, Валюта, НаправлениеДеятельности, НалогообложениеНДС, ЦенаВключаетНДС, Соглашение, ДокументПриобретения");
	ПараметрыУникальныхДокументов.Свернуть("Организация, Комитент, ДоговорСКомитентом, КонтрагентКомитент, Валюта, НаправлениеДеятельности, НалогообложениеНДС, ЦенаВключаетНДС, Соглашение, ДокументПриобретения", "");
