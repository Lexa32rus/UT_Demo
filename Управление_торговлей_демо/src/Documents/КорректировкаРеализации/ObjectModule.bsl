	...
	Иначе
		...
		Если Не Проведен
			...
			Если СтрокиОтразитьНаПрочихДоходах.Количество() Тогда
				...
				МассивТиповНоменклатуры = УчетНДСУПСлужебный.ТипыНоменклатурыТовар();	
				
				Для Каждого Стр Из СтрокиОтразитьНаПрочихДоходах Цикл
					
					Если МассивТиповНоменклатуры.Найти(ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Стр.Номенклатура, "ТипНоменклатуры")) <> Неопределено Тогда 
