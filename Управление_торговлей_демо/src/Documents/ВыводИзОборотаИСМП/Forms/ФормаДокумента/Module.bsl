...
Процедура ПриСозданииЧтенииНаСервере()
	...
	Если Не ПодключенаОбработкаКодовМаркировки Тогда
		СобытияФормИСМП.ПодключитьОбработкуКодовМаркировки(ЭтотОбъект,,"КоличествоПотребительскихУпаковок,GTIN");
...
Процедура НастроитьЗависимыеЭлементыФормы(Форма, СписокРеквизитов = "")
	...
	Элементы.ТоварыЦенаИСуммы.Видимость = ИнтеграцияИСМПСлужебныйКлиентСервер.ИспользованиеЦеныПриВыводеИзОборота(Объект.Операция);
	
	Элементы.Контрагент.Видимость                           = ИнтеграцияИСМПСлужебныйКлиентСервер.ИспользованиеКонтрагентаПриВыводеИзОборота(Объект.Операция);
	Элементы.Контрагент.АвтоОтметкаНезаполненного           = ИнтеграцияИСМПСлужебныйКлиентСервер.ИспользованиеКонтрагентаПриВыводеИзОборота(Объект.Операция, Истина);
...
Процедура ДополнитьДоступныеОперации()
	...
	Если ЭтоАдресВременногоХранилища(ДанныеДокументаАдрес) Тогда
		...
		Если ДанныеДокумента.ВидПродукции = Объект.ВидПродукции
			...
			Элементы.Причина.СписокВыбора.Добавить(ДанныеДокумента.Операция);
		КонецЕсли;
	КонецЕсли;
...
Функция ЗаполнитьДоступныеGTINНаСервере()
	...
	Возврат Документы.ВыводИзОборотаИСМП.ЗаполнитьДоступныеGTIN(Объект)
...
Процедура ПричинаПриИзмененииНаСервере()
	...
	Если Не ИнтеграцияИСМПСлужебныйКлиентСервер.ИспользованиеКонтрагентаПриВыводеИзОборота(Объект.Операция) Тогда
