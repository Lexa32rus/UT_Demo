...
Процедура СмешаннаяОплата(Команда)
	...
	ВыбраннаяФормаОплаты.ЭСФСС = Ложь;
...
Процедура НастроитьРМКЛокализация(ДоступныеВидыОплаты, ЭлементыНаПерегруппировку)
	...
	Элементы.СмешаннаяОплата.Видимость   = Элементы.СмешаннаяОплата.Видимость И ОбщаяСуммаОплатыЭСФСС = 0;
...
Процедура ИнформацияОбОплатеЛокализация(Форма, ИнформацияОбОплате)
	...
	ИтогоОплачено = ИнформацияОбОплате.ИтогоОплачено + ОплатаЭСФССОтменено;
