...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ДоступныеВидыПродукцииИС = ИнтеграцияИСКлиентСервер.ВидыПродукцииИСМП(Истина, , Ложь);
...
Процедура НастроитьЭлементыФормы(Форма)
	...
	Если ЭтоПродукцияМОТП Тогда
		Элементы.ПроизводственныйОбъект.Видимость = Истина;
	...
	ИначеЕсли ИнтеграцияИСКлиентСервер.ЭтоПродукцияИСМП(Объект.ВидПродукции) Тогда
		Элементы.ПроизводственныйОбъект.Видимость  = ЭтоМех;
