...
Процедура УстановитьПредставлениеДокументаОснования()
	...
	Если ЗначениеЗаполнено(Объект.Соглашение)
		И (Не СоглашениеСтарое = Объект.Соглашение
		Или Не Объект.Соглашение.РазбиватьОтчетПоДокументам) Тогда
	...
	Элементы.ОтчетПоПродаже.Видимость = ЗначениеЗаполнено(Объект.Соглашение)
		И Объект.Соглашение.РазбиватьОтчетПоДокументам;
	...
	Если ОтчетПоПродаже Тогда
		...
		Элементы.ТоварыОформитьНедостающиеСчетаФактуры.Видимость = Ложь;
	...
	Иначе
		...
		Элементы.ТоварыОформитьНедостающиеСчетаФактуры.Видимость = Истина;
