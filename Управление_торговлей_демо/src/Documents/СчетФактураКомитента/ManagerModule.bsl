...
Функция ТекстЗапросаТаблицаЖурналУчетаСчетовФактур(Запрос, ТекстыЗапроса, Регистры)
	...
	|	СУММА(ЕСТЬNULL(ТаблицаСуммДокументов.СуммаПоСчетуФактуреЖурнал, Покупатели.СуммаСНДС)) КАК СуммаПоСчетуФактуре,
	|	СУММА(ЕСТЬNULL(ТаблицаСуммДокументов.СуммаНДСЖурнал, Покупатели.СуммаНДС))  КАК СуммаНДС,
	...
	|	NULL,
	|	СУММА(ЕСТЬNULL(ТаблицаСуммДокументов.СуммаПоСчетуФактуреЖурнал, Покупатели.СуммаСНДС)) КАК СуммаПоСчетуФактуреКомиссия,
	|	СУММА(ЕСТЬNULL(ТаблицаСуммДокументов.СуммаНДСЖурнал, Покупатели.СуммаНДС))  КАК СуммаНДСКомиссия,
