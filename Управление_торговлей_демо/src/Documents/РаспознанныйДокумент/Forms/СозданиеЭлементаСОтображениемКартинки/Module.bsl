...
//		Банк = Справочники.Банки.СсылкаНаБанк(БИК);
	...
	//		БанкИзКлассификатора = РаботаСБанками.ПолучитьДанныеКлассификатора(БИК);
		...
		//		Банк = Справочники.КлассификаторБанков.СсылкаНаБанк(БИК);
...
Процедура УстановитьВидимостьЭлементов()
	...
	Элементы.ТипДоговора.ОграничениеТипа = Новый ОписаниеТипов("ПеречислениеСсылка.ТипыДоговоров");
...
Функция РеквизитыСоздаваемогоОбъекта(ПараметрыОткрытия)
	...
	Иначе
		НаборДанных = РаспознаваниеДокументовСлужебныйКлиентСервер.НаборДанныхСозданияЭлемента(
			ДокументОбъект[ДополнительныеДанные.ИмяТаблицы]
		);
	КонецЕсли;
