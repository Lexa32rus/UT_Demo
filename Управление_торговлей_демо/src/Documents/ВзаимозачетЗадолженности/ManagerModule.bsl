...
Функция ТекстЗапросаВтРасчетовПоПоставщикамиПредварительная()
	...
	|			ЗНАЧЕНИЕ(Перечисление.ВидыОперацийВзаимозачетаЗадолженности.УдалитьКлиентаМеждуОрганизациями),
	|			ЗНАЧЕНИЕ(Перечисление.ВидыОперацийВзаимозачетаЗадолженности.УдалитьПоставщикаМеждуОрганизациями),
