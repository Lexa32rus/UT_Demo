...
Процедура ПриКопировании(ОбъектКопирования)
	...
	ДоговорыПоОбъектамРасчетов = ОбщегоНазначения.ЗначениеРеквизитаОбъектов(ЭтотОбъект.РасшифровкаПлатежа.ВыгрузитьКолонку("ОбъектРасчетов"), "Договор", Истина);
	МассивДоговоров = Новый Массив;
	Для Каждого ДоговорПоОбъектуРасчетов Из ДоговорыПоОбъектамРасчетов Цикл
		Если Не ЗначениеЗаполнено(ДоговорПоОбъектуРасчетов.Значение) Тогда
			Продолжить;
		ИначеЕсли МассивДоговоров.Найти(ДоговорПоОбъектуРасчетов.Значение) <> Неопределено Тогда
			Продолжить;
		КонецЕсли;
		МассивДоговоров.Добавить(ДоговорПоОбъектуРасчетов.Значение);
	КонецЦикла;
	СтавкиНДСПоДоговорам = ОбщегоНазначения.ЗначениеРеквизитаОбъектов(МассивДоговоров, "СтавкаНДС", Истина);
	Для Каждого СтрокаРасшифровки Из РасшифровкаПлатежа Цикл
		ТекущийДоговор = ДоговорыПоОбъектамРасчетов.Получить(СтрокаРасшифровки.ОбъектРасчетов);
		Если ЗначениеЗаполнено(ТекущийДоговор) Тогда
			СтрокаРасшифровки.СтавкаНДС = СтавкиНДСПоДоговорам.Получить(ТекущийДоговор);
		КонецЕсли;
	КонецЦикла;
