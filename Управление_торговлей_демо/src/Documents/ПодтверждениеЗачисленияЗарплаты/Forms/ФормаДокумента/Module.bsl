...
Процедура ПриЧтенииСозданииНаСервере()
	...
	СписокОпераций = Элементы.ХозяйственнаяОперация.СписокВыбора;
	
	Если ЗначениеЗаполнено(Объект.ХозяйственнаяОперация) Тогда
		
		ИскомоеЗначение = СписокОпераций.НайтиПоЗначению(Объект.ХозяйственнаяОперация);
	...
	Если Не ЗначениеЗаполнено(Объект.Ссылка)
		...
		Объект.ХозяйственнаяОперация = СписокОпераций.Получить(0).Значение;
	КонецЕсли;
...
Процедура ХозяйственнаяОперацияПриИзмененииНаСервере()
	...
	Объект.СтатьяДвиженияДенежныхСредств = ЗначениеНастроекПовтИсп.ПолучитьСтатьюДвиженияДенежныхСредств(Объект.ХозяйственнаяОперация);
