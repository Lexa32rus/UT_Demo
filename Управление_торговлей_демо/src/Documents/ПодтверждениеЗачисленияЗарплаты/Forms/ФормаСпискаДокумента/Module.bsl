...
Процедура СоздатьЗачислениеНаСервере(ДокументСписания, Адрес)
	
	ДокументЗачисления = Документы.ПодтверждениеЗачисленияЗарплаты.ЗачислениеНаЛицевыеСчета(ДокументСписания);
	ПоместитьВоВременноеХранилище(ДокументЗачисления, Адрес);
...
Процедура СоздатьЗачисление(Команда)
	...
	СоздатьЗачислениеНаСервере(ДокументСписания, АдресХранилища);
	
	Зачисление = ПолучитьИзВременногоХранилища(АдресХранилища);
	ПараметрыФормы = Новый Структура;
	ПараметрыФормы.Вставить("Основание", ДокументСписания);
	ПараметрыФормы.Вставить("Ключ", Зачисление);
	ОткрытьФорму("Документ.ПодтверждениеЗачисленияЗарплаты.ФормаОбъекта",
					ПараметрыФормы, Элементы.НеподтвержденныеПлатежи);
