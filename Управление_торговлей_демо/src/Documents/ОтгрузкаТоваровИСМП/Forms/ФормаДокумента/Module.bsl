...
Процедура ТоварыИдентификаторПроисхожденияВЕТИССтрокойНаФормеПриИзменении(Элемент)
	...
	ТекущиеДанные.ИдентификаторПроисхожденияВЕТИССтрокойНаФорме = ИнтеграцияИСМПКлиентСервер.ПреобразоватьИдентификаторВСД(
...
Процедура ЗаполнитьДоступныеОперации()
	...
	Если Не ИнтеграцияИСКлиентСервер.ЭтоМолочнаяПродукцияИСМП(Объект.ВидПродукции) Тогда
	...
	ВидОперацииЕАЭСПоВидуПродукции = ВидыПродукцииЭкспортЕАЭС.Получить(Объект.ВидПродукции);
	Если ВидОперацииЕАЭСПоВидуПродукции <> Неопределено Тогда
		Элементы.Операция.СписокВыбора.Добавить(ВидОперацииЕАЭСПоВидуПродукции);
	КонецЕсли;
...
&НаСервере
Функция ДоступныеВидыПродукцииИСМП()
