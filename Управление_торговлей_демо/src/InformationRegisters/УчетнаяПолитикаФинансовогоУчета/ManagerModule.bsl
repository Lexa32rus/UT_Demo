...
Функция ТекстЗапросаДействующиеПараметрыНалоговУчетныхПолитик() Экспорт
	...
	|	ТаблицаСрезПоследних.ПорядокНачисленияАмортизацииРегл КАК ПорядокНачисленияАмортизацииРегл,
	|	ТаблицаСрезПоследних.ПорядокНачисленияАмортизацииРеглАренда КАК ПорядокНачисленияАмортизацииРеглАренда,
