...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ДоступнаНастройкаВНА Тогда
		...
		Если РегламентированныйУчетВНА Тогда
			...
			Элементы.ДекорацияПорядокНачисленияАмортизацииРегл.Видимость = Ложь;
			Элементы.ЗаписьПорядокНачисленияАмортизацииРеглСДатыПринятияКУчету.Видимость = Ложь;
			Элементы.ЗаписьПорядокНачисленияАмортизацииРеглСоСледующегоМесяца.Видимость = Ложь;
	...
	Иначе
		...
		Элементы.ЗаписьПорядокУчетаВНАПоСтандартамМУ.Видимость = Ложь;
		Элементы.ЗаписьПорядокУчетаВНАПоСтандартамРегл.Видимость = Ложь;
		Элементы.ДекорацияПорядокНачисленияАмортизации.Видимость = Ложь;
		Элементы.ЗаписьПорядокНачисленияАмортизацииСДатыПринятияКУчету.Видимость = Ложь;
		Элементы.ЗаписьПорядокНачисленияАмортизацииСоСледующегоМесяца.Видимость = Ложь;
