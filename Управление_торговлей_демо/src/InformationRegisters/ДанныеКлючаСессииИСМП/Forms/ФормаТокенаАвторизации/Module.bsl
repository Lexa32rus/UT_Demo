...
Процедура ПолучитьТокен()
	...
	ДействуетДо = Данные.ДействуетДо;
...
Процедура РасшифроватьТокен(Форма)
	...
	Если Форма.ТипТокенаАвторизации = ПредопределенноеЗначение("Перечисление.ТипыТокеновАвторизации.СУЗ") Тогда
