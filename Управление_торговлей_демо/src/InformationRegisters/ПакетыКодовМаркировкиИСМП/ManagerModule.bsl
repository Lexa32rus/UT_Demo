...
Процедура ВыполнитьЗаписьВРегистр(ДанныеЗаписи) Экспорт
	...
	МенеджерЗаписи = РегистрыСведений.ПакетыКодовМаркировкиИСМП.СоздатьМенеджерЗаписи();
...
Процедура УдалитьЗаписиПоДокументу(ДокументОснование) Экспорт
	...
	НаборЗаписей = РегистрыСведений.ПакетыКодовМаркировкиИСМП.СоздатьНаборЗаписей();
