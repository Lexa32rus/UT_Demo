...
Функция ТаблицаСтавокНДСНоменклатуры(Номенклатура, ОтборПоСтране = Неопределено, ОтборПоПериоду = Неопределено)  Экспорт
	...
	|ГДЕ
	|	ПустыеИнтервалыПредварительная.ПустойИнтервалНачало <> ПустыеИнтервалыПредварительная.ПустойИнтервалОкончание
	|
	|ИНДЕКСИРОВАТЬ ПО
	|	Страна,
	...
	|ВЫБРАТЬ
	|	ОсновныеСтавкиНДСПоПериодам.Страна КАК Страна,
	|	МАКСИМУМ(ЕСТЬNULL(ОсновныеСтавкиНДСПоПериодам1.Окончание, ОсновныеСтавкиНДСПоПериодам.Начало)) КАК ПустойИнтервалНачало,
	|	ОсновныеСтавкиНДСПоПериодам.Начало КАК ПустойИнтервалОкончание
	|ПОМЕСТИТЬ ПустыеИнтервалыОсновныеСтавкиПредварительная
	|ИЗ
	|	ОсновныеСтавкиНДСПоПериодам КАК ОсновныеСтавкиНДСПоПериодам
	|		ЛЕВОЕ СОЕДИНЕНИЕ ОсновныеСтавкиНДСПоПериодам КАК ОсновныеСтавкиНДСПоПериодам1
	|		ПО ОсновныеСтавкиНДСПоПериодам.Страна = ОсновныеСтавкиНДСПоПериодам1.Страна
	|			И ОсновныеСтавкиНДСПоПериодам.Начало > ОсновныеСтавкиНДСПоПериодам1.Начало
	|
	|СГРУППИРОВАТЬ ПО
	|	ОсновныеСтавкиНДСПоПериодам.Страна,
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ПустыеИнтервалыОсновныеСтавкиПредварительная.Страна КАК Страна,
	|	ПустыеИнтервалыОсновныеСтавкиПредварительная.ПустойИнтервалНачало КАК ПустойИнтервалНачало,
	|	ПустыеИнтервалыОсновныеСтавкиПредварительная.ПустойИнтервалОкончание КАК ПустойИнтервалОкончание
	|ПОМЕСТИТЬ ПустыеИнтервалыОсновныеСтавки
	|ИЗ
	|	ПустыеИнтервалыОсновныеСтавкиПредварительная КАК ПустыеИнтервалыОсновныеСтавкиПредварительная
	|ГДЕ
	|	ПустыеИнтервалыОсновныеСтавкиПредварительная.ПустойИнтервалНачало <> ПустыеИнтервалыОсновныеСтавкиПредварительная.ПустойИнтервалОкончание
	|
	|ИНДЕКСИРОВАТЬ ПО
	|	Страна,
	|	ПустойИнтервалНачало,
	...
	|
	|ВЫБРАТЬ
	|	ПустыеИнтервалыОсновныеСтавки.Страна,
	|	ПустыеИнтервалыОсновныеСтавки.ПустойИнтервалНачало,
	|	ЗНАЧЕНИЕ(Справочник.СтавкиНДС.ПустаяСсылка),
	|	ЛОЖЬ
	|ИЗ
	|	ПустыеИнтервалыОсновныеСтавки КАК ПустыеИнтервалыОсновныеСтавки
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
